...
public final class SphereProcessor {
  ...
  public static Optional<AxisAlignedBoundingBox> getBoundingBox(SphereModel sphereModel, BoundingBoxParams boundingBoxParams) {
    return sphereModel.getBoundingBox(boundingBoxParams);
  }
}
