...
public final class SceneGenerator {
  ...
  public static Scene generateTwoPerlinSpheres() {
    ...
    SceneObject sphere1 = Sphere
      .builder()
      .setCenter(Vector3.builder().setX(0).setY(-1000).setZ(0).build())
      .setRadius(1000)
      .setMaterial(LambertianMaterial.builder().setTexture(texture).build())
      .build();
    SceneObject sphere2 = Sphere
      .builder()
      .setCenter(Vector3.builder().setX(0).setY(2).setZ(0).build())
      .setRadius(2)
      .setMaterial(LambertianMaterial.builder().setTexture(texture).build())
      .build();
        ...
        ImageTexture
          ...
          .setImageUrl(
            Resources.getResource(
              "src/src/main/resources/textures/earth-8k.jpg"
            )
          )
          .build()
      )
  ...
  public static Scene generateSphereAndLight() {
    ...
    List<SceneObject> sceneObjects = ImmutableList.of(
      ...
      Sphere
        .builder()
        .setCenter(Vector3.builder().setX(0).setY(7).setZ(0).build())
        .setRadius(2)
        .setMaterial(
          DiffuseLightMaterial
            ...
            .setTexture(
              ConstantTexture
                .builder()
                .setColor(Vector3.builder().setX(4).setY(4).setZ(4).build())
                .build()
            )
            .build()
        )
  ...
  public static Scene generateCornellBox() {
    Camera camera = Camera
      ...
      .setLookAt(Vector3.builder().setX(278).setY(278).setZ(0).build())
      .setFocusDistance(10)
      .setAperture(0)
    ...
    Material red = LambertianMaterial
      .builder()
      .setTexture(
        ConstantTexture
          .builder()
          .setColor(Vector3.builder().setX(0.65).setY(0.05).setZ(0.05).build())
          .build()
      )
      .build();
    Material white = LambertianMaterial
      .builder()
      .setTexture(
        ConstantTexture
          .builder()
          .setColor(Vector3.builder().setX(0.73).setY(0.73).setZ(0.73).build())
          .build()
      )
      .build();
    Material green = LambertianMaterial
      .builder()
      .setTexture(
        ConstantTexture
          .builder()
          .setColor(Vector3.builder().setX(0.12).setY(0.45).setZ(0.15).build())
          .build()
      )
      .build();
    Material light = DiffuseLightMaterial
      .builder()
      .setTexture(
        ConstantTexture
          .builder()
          .setColor(Vector3.builder().setX(15).setY(15).setZ(15).build())
          .build()
      )
      .build();
    ...
    List<SceneObject> sceneObjects = ImmutableList.of(
      ...
      Translation
          ...
          YRotation
            ...
            .setSceneObject(
              Box
                ...
                .setPMax(
                  Vector3.builder().setX(165).setY(165).setZ(165).build()
                )
                .setMaterial(white)
                .build()
            )
        ...
        .setOffset(Vector3.builder().setX(130).setY(0).setZ(65).build())
        .build(),
      Translation
        .builder()
        .setSceneObject(
          YRotation
            ...
            .setSceneObject(
              Box
                ...
                .setPMin(Vector3.zero())
                .setPMax(
                  Vector3.builder().setX(165).setY(330).setZ(165).build()
                )
                .setMaterial(white)
                .build()
            )
        ...
        .setOffset(Vector3.builder().setX(265).setY(0).setZ(295).build())
        .build()
    );
  ...
  public static Scene generateCornellSmoke() {
    ...
    List<SceneObject> sceneObjects = ImmutableList.of(
      ...
      ConstantMedium
        ...
        .setDensity(0.01)
        .setTexture(ConstantTexture.builder().setColor(Vector3.one()).build())
        .build(),
      ConstantMedium
        .builder()
        .setSceneObject(
        ...
        .setDensity(0.01)
        .setTexture(ConstantTexture.builder().setColor(Vector3.zero()).build())
        .build()
    );
