...
public class Vector3Test {
  ...
  public void testDotProduct() {
    Vector3 first = Vector3.builder().setX(1).setY(3).setZ(-5).build();

    Vector3 second = Vector3.builder().setX(4).setY(-2).setZ(-1).build();
  ...
  public void testCrossProduct() {
    Vector3 a = Vector3.builder().setX(2).setY(3).setZ(4).build();

    Vector3 b = Vector3.builder().setX(5).setY(6).setZ(7).build();
  ...
  public void testGetI() {
    Vector3 vector = Vector3.builder().setX(10).setY(20).setZ(30).build();
  ...
  @Test
  public void testAdd() {
    Vector3 a = Vector3.builder().setX(100).setY(200).setZ(300).build();

    Vector3 b = Vector3.builder().setX(50).setY(40).setZ(30).build();
